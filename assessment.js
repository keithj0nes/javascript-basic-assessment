...
var array = ["love", "to"];
console.log(addItem(array, "code"));
...
var arra = ["here", "is", "some", "code"];
var s = "some"
//console.log(arra);
removeItem(arra, s);
console.log(removeItem(arra, s));
...
//console.log(getValueOfProperty(object, car));
...
console.log(makeChatMessage("hey here", "keith"))
